...
//
//  Created by Suppasit chuwatsawat on 6/9/2567 BE.
//
...
struct NetflixDetailsProductView: View {
    ...
    var castText: String? = "Case: Nick, Your Name, Someone Else"
    ...
    ZStack {
        ...
        ScrollView {
            VStack(spacing: 40) {
                ...
                NetflixDetailsProductView(isNew: false, hasClosedCaption: false)
                NetflixDetailsProductView(isTopTen: 1)
            }
        }
    }
}
